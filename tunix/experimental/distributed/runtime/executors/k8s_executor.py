...
"""Kubernetes distributed runtime process executor."""
...
class K8sExecutor:
  """Process executor that runs a target main function inside a Kubernetes runtime context."""
  ...
  def run(
    ...
    """Executes `process_main` inside a `K8sProcessContext`.
